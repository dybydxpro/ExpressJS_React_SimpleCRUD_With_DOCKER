        ...
        return(
            data.map((dt, index) => 
                <tr className="hover:bg-slate-100" key={dt.id}>
                    ...
                    <td className="p-4 border-solid border-2 border-slate-300">{dt.firstName}</td>
                    <td className="p-4 border-solid border-2 border-slate-300">{dt.lastName}</td>
                    <td className="p-4 border-solid border-2 border-slate-300 text-center">{dt.age}</td>
                    <td className="p-4 border-solid border-2 border-slate-300">{dt.email}</td>
